...
export function ProjectCard({ project, completedMaterials, totalMaterials, onDelete }: Props) {
  ...
  return (
    <div
      ...
      className="bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-200 dark:border-gray-800 hover:border-gray-400 dark:hover:border-gray-600 cursor-pointer transition-colors group"
    >
